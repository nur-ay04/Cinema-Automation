    ...
    public partial class FrmOyuncuKayit : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (TxtAd.Text != "" && TxtSoyad.Text != "" && TxtBio.Text != "" && PcResim.Image != null)
            {
                ...
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into TblOyuncular (oyuncuAdSoyad, oyuncuCinsiyet, oyuncuYas, oyuncuBio, oyuncuResim) values(@p1, @p2, @p3, @p4, @p5)", baglanti);
                ...
                baglanti.Close();
                MessageBox.Show("Oyuncu bilgileri başarıyla kaydedilmiştir.");
                bilgileriTemizle();
            }
            else
            {
        ...
        private void TxtBio_TextChanged_1(object sender, EventArgs e)
        {
            TxtBio.MaxLength = 300;
            int karakterSayisi = TxtBio.Text.Length;
            int geri = 300 - karakterSayisi;
